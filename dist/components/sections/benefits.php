    ...
    <div class="grid gap-5 md:grid-cols-3">
      ...
      >
        <div class="grid items-center gap-2.5">
          <img src="/assets/img/svg/icon4.svg" alt="<?= $offer_name ?>" width="50" height="50" />
      ...
      >
        <div class="grid items-center gap-2.5">
          <img src="/assets/img/svg/icon5.svg" alt="<?= $offer_name ?>" width="50" height="50" />
      ...
      >
        <div class="grid items-center gap-2.5">
          <img src="/assets/img/svg/icon6.svg" alt="<?= $offer_name ?>" width="50" height="50" />
