    ...
    <div class="grid gap-5 md:grid-cols-3 md:gap-1">
      ...
      >
        <div class="flex min-h-11 items-center gap-2.5">
          <img src="/assets/img/svg/icon1.svg" alt="<?= $offer_name ?>" width="36" height="36" />
      ...
      >
        <div class="flex min-h-11 items-center gap-2.5">
          <img src="/assets/img/svg/icon2.svg" alt="<?= $offer_name ?>" width="36" height="36" />
      ...
      >
        <div class="flex min-h-11 items-center gap-2.5">
          <img src="/assets/img/svg/icon3.svg" alt="<?= $offer_name ?>" width="36" height="36" />
