...
<!-- <div class="main-form">
  <form
    class="main-form__form form _loading"
    name="form"
    method="post"
    action="/?action=send<?= isset($_GET['test']) ? '&test=' . urlencode($_GET['test']) : '' ?>"
    data-form
    data-send="ajax"
    data-validation
    data-after="mainFormAfterSubmit"
  ...
  >
    ...
    <div class="form__section">
      ...
      <div class="form__row form__row_1 form__row_btn">
        <div class="form__column">
          <button class="form__btn btn btn_fw btn_arrow" type="submit">
            <?= t('t.main.signup-now') ?>
    ...
    <div class="form__section">
      <div class="main-form__footer">
        <p>
          <?= t('t.main.main-form__footer', [
							'{privacy_link}' =>
          '<a href="' . url('privacy') . '">' . t('t.main.main_form_privacy_link') . '</a>', '{terms_link}' => '<a
            href="' . url('conditions') . '"
